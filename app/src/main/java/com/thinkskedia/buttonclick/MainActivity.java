package com.thinkskedia.buttonclick;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ourButton2 = (Button) findViewById(R.id.button2);
        ...
        View.OnClickListener ourOnClickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String result = "The button was tapped " + numTimesClicked + " time";
...
//        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Toast toastMessage = Toast.makeText(this, "Text value is now " + '"' + ourMessage.getText() + '"' + ". Now resetting counter...", Toast.LENGTH_LONG);
            toastMessage.show();
            numTimesClicked = 0;
